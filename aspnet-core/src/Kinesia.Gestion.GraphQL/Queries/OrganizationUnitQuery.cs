...
using Kinesia.Gestion.Core.Base;
using Kinesia.Gestion.Core.Extensions;
using Kinesia.Gestion.Dto;
using Kinesia.Gestion.Types;

namespace Kinesia.Gestion.Queries
{
    public class OrganizationUnitQuery : GestionQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
