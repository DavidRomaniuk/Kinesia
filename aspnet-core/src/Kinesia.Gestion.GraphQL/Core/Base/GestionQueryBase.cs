...
namespace Kinesia.Gestion.Core.Base
{
    public abstract class GestionQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected GestionQueryBase(string fieldName,
