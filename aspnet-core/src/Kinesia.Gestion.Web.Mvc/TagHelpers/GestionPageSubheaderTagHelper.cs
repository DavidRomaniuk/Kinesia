...
using Kinesia.Gestion.UiCustomization.Dto;

namespace Kinesia.Gestion.Web.TagHelpers
{
    ...
    public class GestionPageSubheaderTagHelper : TagHelper
    {
        ...
        public GestionPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
