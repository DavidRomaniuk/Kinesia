...
namespace Kinesia.Gestion.Web.Startup
{
    ...
    public class GestionWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public GestionWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GestionWebMvcModule).GetAssembly());
        }
