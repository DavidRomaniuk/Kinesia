...
using Kinesia.Gestion.Web.Models.Account;
...
using Kinesia.Gestion.Web.Security.Recaptcha;
using Kinesia.Gestion.Web.Session;
using Kinesia.Gestion.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : GestionControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(GestionConsts.DateTimeOffsetFormat));
