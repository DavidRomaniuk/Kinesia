...
using Kinesia.Gestion.Configuration.Host;
using Kinesia.Gestion.Editions;
using Kinesia.Gestion.Timing;
using Kinesia.Gestion.Timing.Dto;
using Kinesia.Gestion.Web.Areas.App.Models.HostSettings;
...
namespace Kinesia.Gestion.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : GestionControllerBase
    {
