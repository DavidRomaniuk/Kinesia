...
using Kinesia.Gestion.Organizations;
using Kinesia.Gestion.Web.Areas.App.Models.Notifications;
using Kinesia.Gestion.Web.Areas.App.Models.OrganizationUnits;
...
namespace Kinesia.Gestion.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class NotificationsController : GestionControllerBase
    {
