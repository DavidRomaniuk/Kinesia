...
namespace Kinesia.Gestion.Web.Areas.App.Views.Shared.Themes.Theme3.Components.AppTheme3Brand
{
    public class AppTheme3BrandViewComponent : GestionViewComponent
    {
