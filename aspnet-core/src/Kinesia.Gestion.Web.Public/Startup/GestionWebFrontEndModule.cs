...
namespace Kinesia.Gestion.Web.Public.Startup
{
    [DependsOn(
        typeof(GestionWebCoreModule)
    )]
    public class GestionWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public GestionWebFrontEndModule(IWebHostEnvironment env, GestionEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GestionWebFrontEndModule).GetAssembly());
        }
    }
}
