...
using Kinesia.Gestion.Web.Public.Startup;
using Kinesia.Gestion.Web.Session;
using Kinesia.Gestion.Web.UiCustomization;

namespace Kinesia.Gestion.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : GestionViewComponent
    {
