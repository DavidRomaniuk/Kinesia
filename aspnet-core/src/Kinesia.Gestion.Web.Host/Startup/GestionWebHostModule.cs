...
using Kinesia.Gestion.Authorization.Users.Password;
using Kinesia.Gestion.Configuration;
using Kinesia.Gestion.EntityFrameworkCore;
using Kinesia.Gestion.MultiTenancy;
using Kinesia.Gestion.Web.Startup.ExternalLoginInfoProviders;
...
namespace Kinesia.Gestion.Web.Startup
{
    ...
    public class GestionWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public GestionWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GestionWebHostModule).GetAssembly());
        }
