...
namespace Kinesia.Gestion.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : GestionServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Kinesia.Gestion", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
