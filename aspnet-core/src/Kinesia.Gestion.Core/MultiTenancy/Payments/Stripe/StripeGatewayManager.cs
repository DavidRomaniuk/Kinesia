...
{
    public class StripeGatewayManager : GestionServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Gestion";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + GestionConsts.Currency;
        }
