...
using Kinesia.Gestion.Authorization.Ldap;
...
using Kinesia.Gestion.DashboardCustomization.Definitions;
using Kinesia.Gestion.Debugging;
using Kinesia.Gestion.DynamicEntityProperties;
using Kinesia.Gestion.Features;
using Kinesia.Gestion.Friendships;
using Kinesia.Gestion.Friendships.Cache;
using Kinesia.Gestion.Localization;
using Kinesia.Gestion.MultiTenancy;
using Kinesia.Gestion.Net.Emailing;
using Kinesia.Gestion.Notifications;
using Kinesia.Gestion.WebHooks;
using Newtonsoft.Json;

namespace Kinesia.Gestion
{
    [DependsOn(
        typeof(GestionCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class GestionCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            GestionLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = GestionConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, GestionMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<GestionSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GestionCoreModule).GetAssembly());
        }
