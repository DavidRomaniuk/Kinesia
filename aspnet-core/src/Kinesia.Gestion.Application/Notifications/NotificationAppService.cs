...
using Kinesia.Gestion.Notifications.Dto;
using Kinesia.Gestion.Organizations;

namespace Kinesia.Gestion.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : GestionAppServiceBase, INotificationAppService
    {
