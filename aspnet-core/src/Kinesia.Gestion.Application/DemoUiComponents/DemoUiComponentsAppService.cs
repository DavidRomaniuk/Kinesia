...
using Kinesia.Gestion.DemoUiComponents.Dto;

namespace Kinesia.Gestion.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : GestionAppServiceBase, IDemoUiComponentsAppService
    {
