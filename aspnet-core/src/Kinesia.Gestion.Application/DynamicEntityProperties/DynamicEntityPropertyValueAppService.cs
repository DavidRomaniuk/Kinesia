...
using Kinesia.Gestion.DynamicEntityPropertyValues.Dto;
...
namespace Kinesia.Gestion.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : GestionAppServiceBase, IDynamicEntityPropertyValueAppService
    {
