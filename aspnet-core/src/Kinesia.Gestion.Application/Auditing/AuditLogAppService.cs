...
using Kinesia.Gestion.Auditing.Exporting;
...
using EntityHistoryHelper = Kinesia.Gestion.EntityHistory.EntityHistoryHelper;

namespace Kinesia.Gestion.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : GestionAppServiceBase, IAuditLogAppService
    {
