...
{
    public class SessionAppService : GestionAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = GestionConsts.Currency,
                        CurrencySign = GestionConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = GestionConsts.AllowTenantsToChangeEmailSettings,
