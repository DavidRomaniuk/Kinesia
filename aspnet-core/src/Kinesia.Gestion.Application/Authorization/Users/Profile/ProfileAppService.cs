...
using Kinesia.Gestion.Authorization.Users.Profile.Cache;
    ...
    public class ProfileAppService : GestionAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Kinesia.Gestion",
