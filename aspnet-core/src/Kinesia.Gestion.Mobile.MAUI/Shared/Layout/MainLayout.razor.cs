...
using Kinesia.Gestion.Mobile.MAUI.Services.Tenants;

#if ANDROID
using Kinesia.Gestion.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Kinesia.Gestion.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Kinesia.Gestion.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
