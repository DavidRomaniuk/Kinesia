...
{
    public class SubscriptionPaymentRepository : GestionRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<GestionDbContext> dbContextProvider)
