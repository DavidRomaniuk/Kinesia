...
{
    public class UserRepository : GestionRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<GestionDbContext> dbContextProvider)
