...
namespace Kinesia.Gestion.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = GestionConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(GestionDbContext context)
        {
            _context = context;
        }
