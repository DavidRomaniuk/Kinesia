...
using Kinesia.Gestion.EntityFrameworkCore.Repositories;

namespace Kinesia.Gestion.Organizations
{
    public class UserOrganizationUnitRepository : GestionRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<GestionDbContext> dbContextProvider)
