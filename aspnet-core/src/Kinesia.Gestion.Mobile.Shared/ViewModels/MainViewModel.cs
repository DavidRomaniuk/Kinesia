...
using Kinesia.Gestion.Controls;
using Kinesia.Gestion.Dto;
using Kinesia.Gestion.Extensions;
using Kinesia.Gestion.Localization;
using Kinesia.Gestion.UI;
using Kinesia.Gestion.UI.Assets;
using Kinesia.Gestion.Views;
using DependencyResolver = Kinesia.Gestion.Core.Dependency.DependencyResolver;

namespace Kinesia.Gestion.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Gestion";
