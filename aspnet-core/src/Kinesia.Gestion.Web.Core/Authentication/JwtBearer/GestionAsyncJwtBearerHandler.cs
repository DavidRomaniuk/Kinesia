...
{
    public class GestionAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public GestionAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
