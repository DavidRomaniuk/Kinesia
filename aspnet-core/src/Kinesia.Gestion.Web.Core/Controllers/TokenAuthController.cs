...
using Kinesia.Gestion.Authentication.TwoFactor.Google;
...
namespace Kinesia.Gestion.Web.Controllers
{
    ...
    public class TokenAuthController : GestionControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(GestionConsts.DateTimeOffsetFormat));
