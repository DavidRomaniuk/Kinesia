...
using Kinesia.Gestion.Authentication.TwoFactor;
...
using Kinesia.Gestion.Web.Authentication.JwtBearer;
using Kinesia.Gestion.Web.Authentication.TwoFactor;
using Kinesia.Gestion.Web.Chat.SignalR;
using Kinesia.Gestion.Web.Common;
using Kinesia.Gestion.Web.Configuration;
using Kinesia.Gestion.Web.DashboardCustomization;
using Abp.Extensions;

namespace Kinesia.Gestion.Web
{
    [DependsOn(
    ...
    public class GestionWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public GestionWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(GestionApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GestionWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(GestionWebCoreModule).Assembly);
        }
