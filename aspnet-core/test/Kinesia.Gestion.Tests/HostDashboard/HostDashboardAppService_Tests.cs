...
using Kinesia.Gestion.MultiTenancy.HostDashboard;
using Kinesia.Gestion.MultiTenancy.HostDashboard.Dto;
using Kinesia.Gestion.MultiTenancy.Payments;
using Shouldly;
using System.Globalization;
using Kinesia.Gestion.EntityFrameworkCore;

namespace Kinesia.Gestion.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(GestionDbContext context, SubscriptionPayment subscriptionPayment)
        {
