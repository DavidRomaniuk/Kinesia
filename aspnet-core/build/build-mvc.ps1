...
$webMvcFolder = Join-Path $slnFolder "src/Kinesia.Gestion.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Kinesia.Gestion.Web.Public"
...
dotnet restore Kinesia.Gestion.Web.sln
